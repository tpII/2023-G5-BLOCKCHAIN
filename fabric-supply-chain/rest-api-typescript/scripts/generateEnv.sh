...
DIR_PRIVATE_KEY_FILE_ORG1="${TEST_NETWORK_HOME}/organizations/peerOrganizations/org1.example.com/users/User1@org1.example.com/msp/keystore/"
: "${PRIVATE_KEY_FILE_ORG1:="${DIR_PRIVATE_KEY_FILE_ORG1}/$(basename "${DIR_PRIVATE_KEY_FILE_ORG1}"/*"_sk")"}"
...
DIR_PRIVATE_KEY_FILE_ORG2="${TEST_NETWORK_HOME}/organizations/peerOrganizations/org2.example.com/users/User1@org2.example.com/msp/keystore/"
: "${PRIVATE_KEY_FILE_ORG2:="${DIR_PRIVATE_KEY_FILE_ORG2}/$(basename "${DIR_PRIVATE_KEY_FILE_ORG2}"/*"_sk")"}"

: "${CONNECTION_PROFILE_FILE_ORG3:=${TEST_NETWORK_HOME}/organizations/peerOrganizations/org3.example.com/connection-org3.json}"
: "${CERTIFICATE_FILE_ORG3:=${TEST_NETWORK_HOME}/organizations/peerOrganizations/org3.example.com/users/User1@org3.example.com/msp/signcerts/cert.pem}"
